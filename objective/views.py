...
# objective details
def details_objective(request, id):
...
def edit_objective(request, id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Save the updated instance with many-to-many relationships
            new_objective.save()
...
def create_objective_with_related(request):
    ...
    if request.method == 'POST':
        ...
        definition_of_good_formset = DefinitionOfGoodFormSet(request.POST, prefix='dog')
        ...
        if (
            ...
            for objective_instance in objective_instances:
                objective_instance.definition_of_good.set(definition_of_good_instances)
        ...
        definition_of_good_formset = DefinitionOfGoodFormSet(prefix='good_objects')
