...
class Achievement(general_model.Common_Info):
    ...
    #updated_by = models.ForeignKey(Member,on_delete=models.SET_NULL,null=True, related_name='achieveupdated_by',db_column='updated_by')
...
class Task(models.Model):
    ...
    achievement =models.ForeignKey(Achievement,on_delete=models.CASCADE,null=False,blank=False,db_column='achievement')
    duration=models.DecimalField(max_digits=10,decimal_places=3,null=False,blank=False)
...
class Collaboration(models.Model):
    task=models.ForeignKey(Task,null=False,blank=False,db_column='task',on_delete=models.CASCADE)
