...
urlpatterns = [
    ...
    # update an objective
    path('update_objective/<int:objective_id>/',
         views.update_objective, name='update_objective'),
    # delete an objective
    path('delete_objective/<int:objective_id>/',
    ...
    # get all the actions
    path('action_main_entry_all/', views.action_main_entry_all,
         name='action_main_entry_all'),

    # Publish an objective
    path('publish_objective/<int:objective_id>/',
         views.publish_objective, name='publish_objective'),
    # list of published objectives
    path('published_objectives/', views.published_objectives,
