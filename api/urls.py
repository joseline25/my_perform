...
urlpatterns = [
    ...
    # DELETE
    path('objectives/delete/<int:objective_id>/',
         views.delete_objective, name='delete_objective'),

    # get all the kpis of an objective and create one for this objective
    path('objectives/<int:objective_id>/kpis/',
         views.kpi_list_create, name='kpi_list_create'),

    # create the kpis of an objective
    path('objectives/<int:objective_id>/create_objective_kpi',
         views.create_objective_kpi, name='create_objective_kpi'),
    # get all actions for an objective
    path('objectives/<int:objective_id>/actions/',
         views.action_objective, name='objective_actions_detail_api'),
    # list of questions for an objective
    path('objectives/<int:objective_id>/questions/',
         views.questions, name="action_questions"),

    # get all changes made on an objective

    path('objectives/<int:objective_id>/changes/',
         views.objective_update_changes, name='objective_changes'),
    ...
    # DELETE
    path('delete-teams/delete/<int:id>/',
    ...
    # PUT
    path('skills/update/<int:skill_id>',
    ...
    # GET  all
    path('action-main-entries/', views.action_main_entry_all,
         name='action_main_entry_all'),
    # GET id
    path('action-main-entries/<int:id>/',
         views.action_main_entry_details, name='action_main_entry_details'),

    # DELETE
    path('action-main-entries/delete/<int:id>/',
         views.delete_action_main_entry, name='delete_action_main_entry'),
    # PUT
    path('action-main-entries/update/<int:id>/',
         views.action_main_entry_update, name='action_main_entry_update'),
    # POST
    path('action-main-entries/create/', views.create_action_main_entry,
         name='create_action_main_entry'),

    # GET: get actions for a particular date
    path('action-main-entries/<str:date>/',
         views.get_actions_for_date, name='get_actions_for_date'),
    # http://localhost:8000/action-main-entries/2023-01-01/

    # GET: actions entries in a timeframe
    path('action-main-entries/<str:start_date>/<str:end_date>/',
    ...
    # Employee dashboard
    path('employee_dashboard/<int:user_id>/',
         views.employee_dashboard, name='employee_dashboard'),
    # Supervisor  dashboard
    path('supervisor_dashboard/<int:user_id>/',
